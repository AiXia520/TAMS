...
def main():
    ...
    parser.add_argument("--name", default='aw',
    ...
    parser.add_argument("--target_list", default='data/office/webcam_list.txt', help="Path of the test data.")
    parser.add_argument("--test_list", default='data/office/webcam_list.txt', help="Path of the test data.")
